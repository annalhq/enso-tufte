...
date:   2025-08-31 17:04:01
categories: post
---

Method for sampling from complex distributions using stochastic differential equations.
...
3. $$B_{t_2} - B_{t_1} \sim \mathcal{N}(0, t_2 - t_1)$$ for $$t_2 > t_1$$
4. Almost surely continuous paths, nowhere classically differentiable.
